    ...
    return(
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div className="container sm:w-full sm:max-w-screen-lg mx-auto text-left">
                 ...
                 <p>Terms and Conditions Last updated: May 02, 2024</p>

<p>Please read these terms and conditions carefully before using Our Service.</p>

<h2 className="text-4xl mb-4 mt-4 font-bold">Interpretation and Definitions</h2> 
<h3 className="text-2xl mb-4 mt-4 font-bold">Interpretation</h3> 

<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Definitions</h3>
...
<p>Website refers to Relexco, accessible from Www.relexco.com</p>
...
<h2 className="text-4xl mb-4 mt-4 font-bold">Acknowledgment</h2>
...
<h2 className="text-4xl mb-4 mt-4 font-bold">Placing Orders for Goods</h2>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Your Information</h3> 
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Order Cancellation</h3> 

<p>We reserve the right to refuse or cancel Your Order at any time for certain reasons including but not limited to:</p>

<p>Goods availability Errors in the description or prices for Goods Errors in Your Order We reserve the right to refuse or cancel Your Order if fraud or an unauthorized or illegal transaction is suspected.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Order Cancellation Rights</h3> 

<p>Your Order Cancellation Rights Any Goods you purchase can only be returned in accordance with these Terms and Conditions and Our Returns Policy.</p>
...
<p>The supply of Goods made to Your specifications or clearly personalized. The supply of Goods which according to their nature are not suitable to be returned, deteriorate rapidly or where the date of expiry is over. The supply of Goods which are not suitable for return due to health protection or hygiene reasons and were unsealed after delivery. The supply of Goods which are, after delivery, according to their nature, inseparably mixed with other items. The supply of digital content which is not supplied on a tangible medium if the performance has begun with Your prior express consent and You have acknowledged Your loss of cancellation right. </p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Availability, Errors and Inaccuracies</h3>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Prices Policy</h3>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Payments</h3>
...
<h2 className="text-4xl mb-4 mt-4 font-bold">Links to Other Websites</h2>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Termination</h3>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Governing Law</h3>

<p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Disputes Resolution</h3>

<p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">For European Union (EU) Users </h3>

<p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">United States Legal Compliance</h3>
...
<h3 className="text-2xl mb-4 mt-4 font-bold">Severability and Waiver </h3>

<h4 className="text-xl mb-4 mt-4 font-bold">Severability</h4>

<p> If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Waiver</h3>

<p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Translation Interpretation</h3>

<p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Changes to These Terms and Conditions</h3>

<p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.</p>

<p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</p>

<h3 className="text-2xl mb-4 mt-4 font-bold">Contact Us</h3>
