  ...
  return (
    <div className='flex flex-row'>
      <form onSubmit={handleSubmit}>
        <input name="CommodityCode" value={commodity.CommodityCode} onChange={handleChange} placeholder="Commodity Code" />
        <input name="CommodityDescription" value={commodity.CommodityDescription} onChange={handleChange} placeholder="Commodity Description" />
