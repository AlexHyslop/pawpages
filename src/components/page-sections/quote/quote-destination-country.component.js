...
export default function QuoteDestinationCountry(props) {
    ...
    function selectCountry(countryObj){
      ...
      deepCopyQuote.destinationCountry = countryObj; 
    ...
    return (
      <div>
        <Listbox value={selected} onChange={selectCountry}>
          {({ open }) => (
            <>
              <Listbox.Label className="block text-sm font-extrabold leading-6 text-primary text-left">Destination Country</Listbox.Label>
