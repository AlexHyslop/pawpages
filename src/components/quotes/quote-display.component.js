  ...
  return (
    <div className="quote-display"> 
        <div className="p-6 text-md text-gray-700 bg-gray-50" style={{display:'flex', flexDirection:'column'}}> 
            ...
            <div>
              <p className="text-md break-words">Collection Address: {currentQuote?.collectionAddress?.postalCode + ", "+  currentQuote?.collectionAddress?.city } </p>
            </div>
            <div>
              <p className="text-md break-words"> Delivery Address:{currentQuote?.deliveryAddress?.postalCode + ", "+ currentQuote?.deliveryAddress?.city} </p>
            </div>
        </div>
